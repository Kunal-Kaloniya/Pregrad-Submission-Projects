...
const Page2 = () => {
    ...
    return (
        <div id="section2" className='bg-white text-center p-15 text-black'>

            <h3 className="text-gray-500 text-xl mt-10">© 2025 Amogh.Studio® | designed and developed</h3>
            <div className='rotateText mt-15'>
                <h1 className='text-[42vw] uppercase leading-[36vw]  font-[font2]'>IMPACTFUL</h1>

            </div>
            <div className='rotateText'>
                <h1 className='text-[42vw] uppercase leading-[36vw] font-[font2]'>DESIGN</h1>

            </div>
            <div className='rotateText'>
                <h1 className='text-[42vw] uppercase leading-[36vw] font-[font2]'>IS THE</h1>
            ...
            <div className='rotateText'>
                <h1 className='text-[42vw] uppercase leading-[36vw] font-[font2]'>THAT</h1>

            </div>
            <div className='rotateText'>
                <h1 className='text-[42vw] uppercase leading-[36vw] font-[font2]'>WORKS!</h1>
